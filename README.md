...
-댓글 기능: 게시글에 대한 사용자의 의견이나 피드백을 남길 수 있도록 댓글 기능을 추가하고, 댓글 내에 다시 댓글을 달 수 있는 기능까지 구현할 예정입니다.

-소셜 로그인: OAuth 기능을 통해 소셜 미디어 계정으로 해당 어플리케이션에 가입할 수 있도록 구현할 예정입니다.

-유닛 및 e2e 테스팅: 특별한 기능에 대한 내용은 아니지만, Nest.js와 함께 제공되는 Jest를 활용해 기능별 유닛 테스트를 시도해볼 예정입니다. 또한, 전체 애플리케이션의 흐름을 검증하기 위한 e2e(end-to-end) 테스트도 함께 시도해볼 예정입니다.
